...
public class FlamestrikeMeActiveEffect : ActiveEffectBase
{
    public FlamestrikeMeActiveEffect(IAbility originAbility, IChampion championTarget) 
        : base(LutherConstants.FlamestrikeMeActiveEffect, originAbility, championTarget)
    {
